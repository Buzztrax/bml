...
static void
_log_null_printf (const char *file, const int line, const char *func, const char *fmt, ...)
{
}
...
static void _log_stdout_logger(char *str) {
#ifdef LOG
...
static void _log_null_logger(char *str) {
}
