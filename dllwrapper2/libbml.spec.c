...
static struct {
  ...
  },
  {
    ...
    "\317\001GetCurrentProcess",
    "\320\001GetCurrentProcessId",
    "\365\001GetFullPathNameA",
...
asm(".data\n\t.align 8\n"
    ...
    "\t.globl GetCurrentProcess\n"
    "GetCurrentProcess:\n\tjmp *(imports+56)\n\tmovl %esi,%esi\n"
    "\t.size GetCurrentProcess, . - GetCurrentProcess\n"
    "\t.type GetCurrentProcessId,@function\n"
    "\t.globl GetCurrentProcessId\n"
    "GetCurrentProcessId:\n\tjmp *(imports+60)\n\tmovl %esi,%esi\n"
    "\t.size GetCurrentProcessId, . - GetCurrentProcessId\n"
    "\t.type GetFullPathNameA,@function\n"
    "\t.globl GetFullPathNameA\n"
    "GetFullPathNameA:\n\tjmp *(imports+64)\n\tmovl %esi,%esi\n"
    "\t.size GetFullPathNameA, . - GetFullPathNameA\n"
...
void __wine_spec_init(void)
{
    ...
    __wine_dll_register( &nt_header, "libbml.exe" );
}
